...
if __name__ == "__main__":
    ...
    np.save(os.path.join("Asian/", "training_history_dim_"+str(dim)+"_seed_"+str(seeds), training_history) 
    np.save(os.path.join("Asian/", "mcprice_dim_"+str(dim)+"_seed_"+str(seeds), mcprice) 
