...
class TestaAsianFunc(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        """
        Unit test for each component of Equation for 100-stock basket Asian options  
        """
        super(TestaAsianFunc, self).__init__(*args, **kwargs)
