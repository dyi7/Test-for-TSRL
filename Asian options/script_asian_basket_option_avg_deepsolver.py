...
from PureJumpSolver_deepsolver_avg import BSDESolver
...
if __name__ == "__main__":
    ...
    # np.save("Asian/DeepSolver/training_history_dim_"+str(dim)+"_seed_"+str(seeds),training_history) # loss
    # np.save("Asian/DeepSolver/mcprice_dim_"+str(dim)+"_seed_"+str(seeds), mcprice)
