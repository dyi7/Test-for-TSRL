...
class BSDESolver(object):
    ...
    def loss_fn(self, inputs, training):
        ...
        y_terminal, y_average, penalty = self.model(inputs, training)
        delta = y_average - self.bsde.g_tf(self.bsde.total_time, x)
...
class NonsharedModel(tf.keras.Model):
    ...
    def call(self, inputs, training):
        ...
        y_avg = tf.reduce_mean(history, -1) 

        return y, y_avg, penalty
