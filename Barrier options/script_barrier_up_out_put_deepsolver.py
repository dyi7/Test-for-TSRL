...
if __name__ == "__main__":
    ...
    np.save(os.path.join("Barrier/", "training_history_dim_"+str(dim)+"_"+str(barrier_direction)+"_"+str(optionality)+"_put", training_history) 
    np.save(os.path.join("Barrier/", "mcprice_dim_"+str(dim)+"_"+str(barrier_direction)+"_"+str(optionality)+"_put", mcprice)
            
    # np.save("Barrier/training_history_dim_"+str(dim)+"_"+str(barrier_direction)+"_"+str(optionality)+"_put",training_history)
    # np.save("Barrier/mcprice_dim_"+str(dim)+"_"+str(barrier_direction)+"_"+str(optionality)+"_put", mcprice)
