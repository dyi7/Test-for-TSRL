...
"""
Regression test for the experiment of an up-and-out put option
...
class TestIntegUpOutPut(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        """
        Integrated test for the up-and-out put options
        """
    ...
    def test_error(self):
        ...
        mcprice = np.load('Barrier/mcprice_dim_1_Up_Out_put__S0_1.0.npy',allow_pickle=True)
    ...
    def test_f_tf(self):
        print("Unit test for each component of Equation for Up-and-out put options")
        """
