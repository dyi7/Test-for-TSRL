...
if __name__ == "__main__":
    ...
    config = {
                "eqn_config": {
                    "_comment": "barrier call option",  # call options
    ...
    np.save(os.path.join("Barrier/", "training_history_dim_"+str(dim)+"_"+str(barrier_direction)+"_"+str(optionality)+"_call", training_history) 
    np.save(os.path.join("Barrier/", "stock_"+str(dim)+"_"+str(barrier_direction)+"_"+str(optionality)+"_call", stock)
    np.save(os.path.join("Barrier/", "mcprice_dim_"+str(dim)+"_"+str(barrier_direction)+"_"+str(optionality)+"_call", mcprice)
            
    # np.save("Barrier/training_history_dim_"+str(dim)+"_"+str(barrier_direction)+"_"+str(optionality)+"_call",training_history)
    # np.save("Barrier/stock_"+str(dim)+"_"+str(barrier_direction)+"_"+str(optionality)+"_call", stock)
    # np.save("Barrier/mcprice_dim_"+str(dim)+"_"+str(barrier_direction)+"_"+str(optionality)+"_call", mcprice)
