...
if __name__ == "__main__":
    ...
    os.makedirs("Barrier/American/", exist_ok=True)
    np.save(os.path.join("Barrier/American/", "training_history_dim_"+str(dim)+"_"+str(barrier_direction)+"_"+str(optionality)+"_put_ameri", training_history) 
    np.save(os.path.join("Barrier/American/", "stock_"+str(dim)+"_"+str(barrier_direction)+"_"+str(optionality)+"_put_ameri", stock) 
    np.save(os.path.join("Barrier/American/", "european_dim_"+str(dim)+"_"+str(barrier_direction)+"_"+str(optionality)+"_put_ameri", mcprice) 
    np.save(os.path.join("Barrier/American/", "american_dim_"+str(dim)+"_"+str(barrier_direction)+"_"+str(optionality)+"_put_ameri", ame_price) 
