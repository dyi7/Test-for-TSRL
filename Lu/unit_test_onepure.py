...
class TestOnePureFunc(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        """
        Unit test for each component of Lu's equation (3.2), in one pure jump process
        """
        super(TestOnePureFunc, self).__init__(*args, **kwargs)
